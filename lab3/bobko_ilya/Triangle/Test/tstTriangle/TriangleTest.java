...
public class TriangleTest {
	...
	@Test
	public void getSquare_Correct_Triangle_tst(){
		parameterA = 15;
		parameterB = 12;
		parameterC = 14;
		Triangle triangle = new Triangle(parameterA, parameterB, parameterC);
	
    	assertEquals(78.926, triangle.getSquare(), 0.001);	
	}
	@Test
	public void getSquare_Three_Equal_C_tst(){
		parameterA = 1;
		parameterB = 2;
		parameterC = 3;
		Triangle triangle = new Triangle(parameterA, parameterB, parameterC);
	
    	assertEquals(0, triangle.getSquare(), 0.001);	
	}
	@Test
    public void getSquare_Negative_C_tst() {
        parameterA = 4;
		parameterB = 5;
		parameterC = -3;
		Triangle triangle = new Triangle(parameterA, parameterB, parameterC);
